            ...
            <div className="mx-auto max-w-2xl">
                <div className="overflow-hidden rounded-xl border border-gray-200 bg-white shadow-sm dark:border-slate-700 dark:bg-slate-800">
                    <div className="border-b border-gray-200 px-6 py-4 dark:border-slate-700">
                        <h2 className="text-lg font-semibold text-gray-900 dark:text-white">{isEdit ? 'Edit Pengguna' : 'Tambah Pengguna Baru'}</h2>
                        <p className="mt-1 text-sm text-gray-500 dark:text-slate-400">Isi informasi pengguna di bawah ini</p>
                    </div>
