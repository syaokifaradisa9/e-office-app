...
namespace Modules\Archieve\Providers;
...
class ArchieveServiceProvider extends ServiceProvider
{
    use PathNamespace;

    protected string $name = 'Archieve';

    protected string $nameLower = 'archieve';
