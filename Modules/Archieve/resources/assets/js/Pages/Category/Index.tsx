...
import { Folder, Edit, Plus, Trash2, FileSpreadsheet, Shield, Layers } from 'lucide-react';
...
export default function CategoryIndex() {
    ...
    async function loadDatatable() {
        ...
        setIsLoading(true);
        let url = `/archieve/categories/datatable`;
    ...
    const typeOptions = [
        { value: 'fungsi', label: 'Berdasarkan Fungsi/Kegunaan' },
        { value: 'keaslian', label: 'Berdasarkan Keaslian' },
        { value: 'media', label: 'Berdasarkan Bentuk/Media' },
    ];
    ...
    return (
        ...
        >
            <ConfirmationAlert
                ...
                onConfirm={() => {
                    if (selectedItem?.id) {
                        router.delete(`/archieve/categories/${selectedItem.id}`, {
